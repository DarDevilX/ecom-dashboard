    ...
    return(
        ...
        <h1>Halaman Add Products</h1>
            <div className="col-sm-6 offset-sm-3">
                <input type="text" onChange={(e)=>setName(e.target.value)} name="name" className="form-control" placeholder="Name" />
                <br />
                <input type="file" onChange={(e)=>setFile(e.target.files[0])} name="file" className="form-control" placeholder="Choose File..." />
                <br />
                <input type="text" onChange={(e)=>setPrice(e.target.value)} name="price" className="form-control" placeholder="Price" />
                <br />
                <input type="text" onChange={(e)=>setDescription(e.target.value)} name="description" className="form-control" placeholder="Description"/>
                <br />
